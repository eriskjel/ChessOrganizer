...
public class TournamentDeserializer extends StdDeserializer{
    ...
    public Object deserialize(JsonParser jp, DeserializationContext deserializationContext) throws IOException{
        ...
        ArrayList<Match[]> bracket  = mapper.convertValue(node.get("tournamentBracket"),ArrayList.class);
        JsonNode pNode = node.get("playerRegistry");
        PlayerRegistry players = mapper.readValue(pNode.traverse(mapper), PlayerRegistry.class);
