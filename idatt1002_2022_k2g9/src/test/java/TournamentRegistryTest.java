...
public class TournamentRegistryTest {
    ...
    public void testGetTournament() {
        ...
        Tournament testT1 = new Tournament("Tournament 1", LocalDate.parse("2022-03-23"), organizer, players,"Knock-out");
        Tournament testT2 = new Tournament("Tournament 2", LocalDate.parse("2022-03-22"), organizer, players,"Knock-out");
        Tournament testT3 = new Tournament("Tournament 3", LocalDate.parse("2022-03-21"), organizer, players,"Knock-out");
